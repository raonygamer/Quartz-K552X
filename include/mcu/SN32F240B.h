...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t SYSCLKSEL : 1;
            /*!< [0..0] System clock source selection                                      */
            uint32_t  : 3;
            __IM  uint32_t SYSCLKST : 1;
            /*!< [4..4] System clock switch status                                         */
        } CLKCFG_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t WDTRSTF : 1;
            /*!< [1..1] WDT reset flag                                                     */
            __IOM uint32_t LVDRSTF : 1;
            /*!< [2..2] LVD reset flag                                                     */
            __IOM uint32_t EXTRSTF : 1;
            /*!< [3..3] External reset flag                                                */
            __IOM uint32_t PORRSTF : 1;
            /*!< [4..4] POR reset flag                                                     */
        } RSTST_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t LVDRSTLVL : 3;
            /*!< [2..0] LVD reset level                                                    */
            uint32_t  : 1;
            __IOM uint32_t LVDINTLVL : 3;
            /*!< [6..4] LVD interrupt level                                                */
            uint32_t  : 7;
            __IOM uint32_t LVDRSTEN : 1;
            /*!< [14..14] LVD Reset enable                                                 */
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t RESETDIS : 1;
            /*!< [0..0] External reset pin disable                                         */
        } EXRSTCTRL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            uint32_t  : 14;
            __OM  uint32_t IVTMKEY : 16;
            /*!< [31..16] IVTM register key                                                */
        } IVTM_b;
    };
    ...
    union
    {
        ...
        {
            uint32_t  : 1;
            __IOM uint32_t NDT5V_IE : 1;
            /*!< [1..1] NDT for VDD 5V interrupt enable bit                                */
        } NDTCTRL_b;
    };
    ...
    union
    {
        ...
        {
            uint32_t  : 1;
            __IOM uint32_t NDT5V_DET : 1;
            /*!< [1..1] Power noise status of NDT5V                                        */
        } NDTSTS_b;
    };
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t P0CLKEN : 1;
            /*!< [0..0] Enable AHB clock for P0                                            */
            __IOM uint32_t P1CLKEN : 1;
            /*!< [1..1] Enable AHB clock for P1                                            */
            __IOM uint32_t P2CLKEN : 1;
            /*!< [2..2] Enable AHB clock for P2                                            */
            __IOM uint32_t P3CLKEN : 1;
            /*!< [3..3] Enable AHB clock for P3                                            */
            __IOM uint32_t USBCLKEN : 1;
            /*!< [4..4] Enable AHB clock for USB                                           */
            uint32_t  : 1;
            __IOM uint32_t CT16B0CLKEN : 1;
            /*!< [6..6] Enable AHB clock for CT16B0                                        */
            __IOM uint32_t CT16B1CLKEN : 1;
            /*!< [7..7] Enable AHB clock for CT16B1                                        */
            uint32_t  : 3;
            __IOM uint32_t ADCCLKEN : 1;
            /*!< [11..11] Enable AHB clock for ADC                                         */
            __IOM uint32_t SPI0CLKEN : 1;
            /*!< [12..12] Enable AHB clock for SPI0                                        */
            uint32_t  : 3;
            __IOM uint32_t UART0CLKEN : 1;
            /*!< [16..16] Enable AHB clock for UART0                                       */
            __IOM uint32_t UART1CLKEN : 1;
            /*!< [17..17] Enable AHB clock for UART1                                       */
            __IOM uint32_t UART2CLKEN : 1;
            /*!< [18..18] Enable AHB clock for UART2                                       */
            uint32_t  : 2;
            __IOM uint32_t I2C0CLKEN : 1;
            /*!< [21..21] Enable AHB clock for I2C0                                        */
            uint32_t  : 2;
            __IOM uint32_t WDTCLKEN : 1;
            /*!< [24..24] Enable AHB clock for WDT                                         */
            uint32_t  : 3;
            __IOM uint32_t CLKOUTSEL : 3;
            /*!< [30..28] Clock output source selection                                    */
        } AHBCLKEN_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            uint32_t  : 5;
            __IOM uint32_t CLKOUTPRE : 3;
            /*!< [30..28] CLKOUT APB clock source prescaler                                */
        } APBCP1_b;
    };
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t AVREFHSEL : 1;
            /*!< [12..12] ADC high reference voltage source                                */
...
typedef struct
{
    /*!< (@ 0x40000000) SN_CT16B0 Structure                                        */
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t MR0STOP : 1;
            /*!< [2..2] Stop TC and PC and clear CEN bit when MR0 matches TC               */
        } MCTRL_b;
    };
...
typedef struct
{
    /*!< (@ 0x40002000) SN_CT16B1 Structure                                        */
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t MR1STOP : 1;
            /*!< [5..5] Stop TC and PC and clear CEN bit when MR1 matches TC               */
            ...
            __IOM uint32_t MR2STOP : 1;
            /*!< [8..8] Stop TC and PC and clear CEN bit when MR2 matches TC               */
            ...
            __IOM uint32_t MR3STOP : 1;
            /*!< [11..11] Stop TC and PC and clear CEN bit when MR3 matches TC             */
            ...
            __IOM uint32_t MR4STOP : 1;
            /*!< [14..14] Stop TC and PC and clear CEN bit when MR4 matches TC             */
            ...
            __IOM uint32_t MR5STOP : 1;
            /*!< [17..17] Stop TC and PC and clear CEN bit when MR5 matches TC             */
            ...
            __IOM uint32_t MR6STOP : 1;
            /*!< [20..20] Stop TC and PC and clear CEN bit when MR6 matches TC             */
            ...
            __IOM uint32_t MR7STOP : 1;
            /*!< [23..23] Stop TC and PC and clear CEN bit when MR7 matches TC             */
            ...
            __IOM uint32_t MR8STOP : 1;
            /*!< [26..26] Stop TC and PC and clear CEN bit when MR8 matches TC             */
            ...
            __IOM uint32_t MR9STOP : 1;
            /*!< [29..29] Stop TC and PC and clear CEN bit when MR9 matches TC             */
        } MCTRL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t MR10RST : 1;
            /*!< [1..1] Enable reset TC when MR10 matches TC                               */
            __IOM uint32_t MR10STOP : 1;
            /*!< [2..2] Stop TC and PC and clear CEN bit when MR10 matches TC              */
            __IOM uint32_t MR11IE : 1; /*!< [3..3] Enable generating an interrupt when MR11 matches TC                */
            __IOM uint32_t MR11RST : 1;
            /*!< [4..4] Enable reset TC when MR11 matches TC                               */
            __IOM uint32_t MR11STOP : 1;
            /*!< [5..5] Stop TC and PC and clear CEN bit when MR11 matches TC              */
            __IOM uint32_t MR12IE : 1; /*!< [6..6] Enable generating an interrupt when MR12 matches TC                */
            __IOM uint32_t MR12RST : 1;
            /*!< [7..7] Enable reset TC when MR12 matches TC                               */
            __IOM uint32_t MR12STOP : 1;
            /*!< [8..8] Stop TC and PC and clear CEN bit when MR12 matches TC              */
            __IOM uint32_t MR13IE : 1; /*!< [9..9] Enable generating an interrupt when MR13 matches TC                */
            __IOM uint32_t MR13RST : 1;
            /*!< [10..10] Enable reset TC when MR13 matches TC                             */
            ...
            __IOM uint32_t MR14RST : 1;
            /*!< [13..13] Enable reset TC when MR14 matches TC                             */
            ...
            __IOM uint32_t MR15RST : 1;
            /*!< [16..16] Enable reset TC when MR15 matches TC                             */
            ...
            __IOM uint32_t MR16RST : 1;
            /*!< [19..19] Enable reset TC when MR16 matches TC                             */
            ...
            __IOM uint32_t MR17RST : 1;
            /*!< [22..22] Enable reset TC when MR17 matches TC                             */
            ...
            __IOM uint32_t MR18RST : 1;
            /*!< [25..25] Enable reset TC when MR18 matches TC                             */
            ...
            __IOM uint32_t MR19RST : 1;
            /*!< [28..28] Enable reset TC when MR19 matches TC                             */
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t MR20RST : 1;
            /*!< [1..1] Enable reset TC when MR20 matches TC                               */
            __IOM uint32_t MR20STOP : 1;
            /*!< [2..2] Stop TC and PC and clear CEN bit when MR20 matches TC              */
            __IOM uint32_t MR21IE : 1; /*!< [3..3] Enable generating an interrupt when MR21 matches TC                */
            __IOM uint32_t MR21RST : 1;
            /*!< [4..4] Enable reset TC when MR21 matches TC                               */
            __IOM uint32_t MR21STOP : 1;
            /*!< [5..5] Stop TC and PC and clear CEN bit when MR21 matches TC              */
            __IOM uint32_t MR22IE : 1; /*!< [6..6] Enable generating an interrupt when MR22 matches TC                */
            __IOM uint32_t MR22RST : 1;
            /*!< [7..7] Enable reset TC when MR22 matches TC                               */
            __IOM uint32_t MR22STOP : 1;
            /*!< [8..8] Stop TC and PC and clear CEN bit when MR22 matches TC              */
            __IOM uint32_t MR23IE : 1; /*!< [9..9] Enable generating an interrupt when MR23 matches TC                */
            __IOM uint32_t MR23RST : 1;
            /*!< [10..10] Enable reset TC when MR23 matches TC                             */
            ...
            __IOM uint32_t MR24RST : 1;
            /*!< [13..13] Enable reset TC when MR24 matches TC                             */
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PWM0MODE : 2;
            /*!< [1..0] PWM0 output mode                                                   */
            __IOM uint32_t PWM1MODE : 2;
            /*!< [3..2] PWM1 output mode                                                   */
            __IOM uint32_t PWM2MODE : 2;
            /*!< [5..4] PWM2 output mode                                                   */
            __IOM uint32_t PWM3MODE : 2;
            /*!< [7..6] PWM3 output mode                                                   */
            __IOM uint32_t PWM4MODE : 2;
            /*!< [9..8] PWM4 output mode                                                   */
            __IOM uint32_t PWM5MODE : 2;
            /*!< [11..10] PWM5 output mode                                                 */
            __IOM uint32_t PWM6MODE : 2;
            /*!< [13..12] PWM6 output mode                                                 */
            __IOM uint32_t PWM7MODE : 2;
            /*!< [15..14] PWM7 output mode                                                 */
            __IOM uint32_t PWM8MODE : 2;
            /*!< [17..16] PWM8 output mode                                                 */
            __IOM uint32_t PWM9MODE : 2;
            /*!< [19..18] PWM9 output mode                                                 */
            __IOM uint32_t PWM10MODE : 2;
            /*!< [21..20] PWM10 output mode                                                */
            __IOM uint32_t PWM11MODE : 2;
            /*!< [23..22] PWM11 output mode                                                */
            __IOM uint32_t PWM12MODE : 2;
            /*!< [25..24] PWM12 output mode                                                */
            __IOM uint32_t PWM13MODE : 2;
            /*!< [27..26] PWM13 output mode                                                */
            __IOM uint32_t PWM14MODE : 2;
            /*!< [29..28] PWM14 output mode                                                */
            __IOM uint32_t PWM15MODE : 2;
            /*!< [31..30] PWM15 output mode                                                */
        } PWMCTRL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PWM16MODE : 2;
            /*!< [1..0] PWM16 output mode                                                  */
            __IOM uint32_t PWM17MODE : 2;
            /*!< [3..2] PWM17 output mode                                                  */
            __IOM uint32_t PWM18MODE : 2;
            /*!< [5..4] PWM18 output mode                                                  */
            __IOM uint32_t PWM19MODE : 2;
            /*!< [7..6] PWM19 output mode                                                  */
            __IOM uint32_t PWM20MODE : 2;
            /*!< [9..8] PWM20 output mode                                                  */
            __IOM uint32_t PWM21MODE : 2;
            /*!< [11..10] PWM21 output mode                                                */
            __IOM uint32_t PWM22MODE : 2;
            /*!< [13..12] PWM22 output mode                                                */
            __IOM uint32_t PWM23MODE : 2;
            /*!< [15..14] PWM23 output mode                                                */
        } PWMCTRL2_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t PWM10EN : 1;
            /*!< [10..10] PWM10 enable                                                     */
            __IOM uint32_t PWM11EN : 1;
            /*!< [11..11] PWM11 enable                                                     */
            __IOM uint32_t PWM12EN : 1;
            /*!< [12..12] PWM12 enable                                                     */
            __IOM uint32_t PWM13EN : 1;
            /*!< [13..13] PWM13 enable                                                     */
            __IOM uint32_t PWM14EN : 1;
            /*!< [14..14] PWM14 enable                                                     */
            __IOM uint32_t PWM15EN : 1;
            /*!< [15..15] PWM15 enable                                                     */
            __IOM uint32_t PWM16EN : 1;
            /*!< [16..16] PWM16 enable                                                     */
            __IOM uint32_t PWM17EN : 1;
            /*!< [17..17] PWM17 enable                                                     */
            __IOM uint32_t PWM18EN : 1;
            /*!< [18..18] PWM18 enable                                                     */
            __IOM uint32_t PWM19EN : 1;
            /*!< [19..19] PWM19 enable                                                     */
            __IOM uint32_t PWM20EN : 1;
            /*!< [20..20] PWM20 enable                                                     */
            __IOM uint32_t PWM21EN : 1;
            /*!< [21..21] PWM21 enable                                                     */
            __IOM uint32_t PWM22EN : 1;
            /*!< [22..22] PWM22 enable                                                     */
            __IOM uint32_t PWM23EN : 1;
            /*!< [23..23] PWM23 enable                                                     */
        } PWMENB_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PWM0IOEN : 1;
            /*!< [0..0] CT16Bn_PWM0/GPIO selection                                         */
            __IOM uint32_t PWM1IOEN : 1;
            /*!< [1..1] CT16Bn_PWM1/GPIO selection                                         */
            __IOM uint32_t PWM2IOEN : 1;
            /*!< [2..2] CT16Bn_PWM2/GPIO selection                                         */
            __IOM uint32_t PWM3IOEN : 1;
            /*!< [3..3] CT16Bn_PWM3/GPIO selection                                         */
            __IOM uint32_t PWM4IOEN : 1;
            /*!< [4..4] CT16Bn_PWM4/GPIO selection                                         */
            __IOM uint32_t PWM5IOEN : 1;
            /*!< [5..5] CT16Bn_PWM5/GPIO selection                                         */
            __IOM uint32_t PWM6IOEN : 1;
            /*!< [6..6] CT16Bn_PWM6/GPIO selection                                         */
            __IOM uint32_t PWM7IOEN : 1;
            /*!< [7..7] CT16Bn_PWM7/GPIO selection                                         */
            __IOM uint32_t PWM8IOEN : 1;
            /*!< [8..8] CT16Bn_PWM8/GPIO selection                                         */
            __IOM uint32_t PWM9IOEN : 1;
            /*!< [9..9] CT16Bn_PWM9/GPIO selection                                         */
            __IOM uint32_t PWM10IOEN : 1;
            /*!< [10..10] CT16Bn_PWM10/GPIO selection                                      */
            __IOM uint32_t PWM11IOEN : 1;
            /*!< [11..11] CT16Bn_PWM11/GPIO selection                                      */
            __IOM uint32_t PWM12IOEN : 1;
            /*!< [12..12] CT16Bn_PWM12/GPIO selection                                      */
            __IOM uint32_t PWM13IOEN : 1;
            /*!< [13..13] CT16Bn_PWM13/GPIO selection                                      */
            __IOM uint32_t PWM14IOEN : 1;
            /*!< [14..14] CT16Bn_PWM14/GPIO selection                                      */
            __IOM uint32_t PWM15IOEN : 1;
            /*!< [15..15] CT16Bn_PWM15/GPIO selection                                      */
            __IOM uint32_t PWM16IOEN : 1;
            /*!< [16..16] CT16Bn_PWM16/GPIO selection                                      */
            __IOM uint32_t PWM17IOEN : 1;
            /*!< [17..17] CT16Bn_PWM17/GPIO selection                                      */
            __IOM uint32_t PWM18IOEN : 1;
            /*!< [18..18] CT16Bn_PWM18/GPIO selection                                      */
            __IOM uint32_t PWM19IOEN : 1;
            /*!< [19..19] CT16Bn_PWM19/GPIO selection                                      */
            __IOM uint32_t PWM20IOEN : 1;
            /*!< [20..20] CT16Bn_PWM20/GPIO selection                                      */
            __IOM uint32_t PWM21IOEN : 1;
            /*!< [21..21] CT16Bn_PWM21/GPIO selection                                      */
            __IOM uint32_t PWM22IOEN : 1;
            /*!< [22..22] CT16Bn_PWM22/GPIO selection                                      */
            __IOM uint32_t PWM23IOEN : 1;
            /*!< [23..23] CT16Bn_PWM23/GPIO selection                                      */
        } PWMIOENB_b;
    };
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t LOOPBACK : 1;
            /*!< [1..1] Loopback mode enable                                               */
            ...
            __IOM uint32_t TXFIFOTH : 3;
            /*!< [14..12] TX FIFO Threshold level                                          */
            __IOM uint32_t RXFIFOTH : 3;
            /*!< [17..15] RX FIFO Threshold level                                          */
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [0..0] TX FIFO empty flag                                                 */
            __IM  uint32_t TX_FULL : 1;
            /*!< [1..1] TX FIFO full flag                                                  */
            __IM  uint32_t RX_EMPTY : 1;
            /*!< [2..2] RX FIFO empty flag                                                 */
            __IM  uint32_t RX_FULL : 1;
            /*!< [3..3] RX FIFO full flag                                                  */
            __IM  uint32_t BUSY : 1; /*!< [4..4] Busy flag                                                          */
            __IM  uint32_t TXFIFOTHF : 1;
            /*!< [5..5] TX FIFO threshold flag                                             */
            __IM  uint32_t RXFIFOTHF : 1;
            /*!< [6..6] RX FIFO threshold flag                                             */
        } STAT_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [0..0] RX FIFO overflow interrupt enable                                  */
            __IOM uint32_t RXTOIE : 1; /*!< [1..1] RX time-out interrupt enable                                       */
            __IOM uint32_t RXFIFOTHIE : 1;
            /*!< [2..2] RX FIFO threshold interrupt enable                                 */
            __IOM uint32_t TXFIFOTHIE : 1;
            /*!< [3..3] TX FIFO threshold interrupt enable                                 */
        } IE_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [0..0] RX FIFO overflow interrupt flag                                    */
            __IM  uint32_t RXTOIF : 1; /*!< [1..1] RX time-out interrupt flag                                         */
            __IM  uint32_t RXFIFOTHIF : 1;
            /*!< [2..2] RX FIFO threshold interrupt flag                                   */
            __IM  uint32_t TXFIFOTHIF : 1;
            /*!< [3..3] TX FIFO threshold interrupt flag                                   */
        } RIS_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __OM  uint32_t RXOVFIC : 1;
            /*!< [0..0] RX FIFO overflow flag clear                                        */
            __OM  uint32_t RXTOIC : 1; /*!< [1..1] RX time-out interrupt flag clear                                   */
            __OM  uint32_t RXFIFOTHIC : 1;
            /*!< [2..2] RX Interrupt flag Clear                                            */
            __OM  uint32_t TXFIFOTHIC : 1;
            /*!< [3..3] TX Interrupt flag Clear                                            */
        } IC_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t DFETCH_EN : 1;
            /*!< [0..0] SPI0 data fetch control bit                                        */
        } DFDLY_b;
    };
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __IM  uint32_t ACK_STAT : 1;
            /*!< [1..1] ACK done status                                                    */
            __IM  uint32_t NACK_STAT : 1;
            /*!< [2..2] NACK done status                                                   */
            __IM  uint32_t STOP_DN : 1;
            /*!< [3..3] STOP done status                                                   */
            __IM  uint32_t START_DN : 1;
            /*!< [4..4] START done status                                                  */
            __IM  uint32_t MST : 1; /*!< [5..5] I2C master/slave status                                            */
            __IM  uint32_t SLV_RX_HIT : 1;
            /*!< [6..6] Slave RX address hit flag                                          */
            __IM  uint32_t SLV_TX_HIT : 1;
            /*!< [7..7] Slave TX address hit flag                                          */
            __IM  uint32_t LOST_ARB : 1;
            /*!< [8..8] Lost arbitration status                                            */
...
typedef struct
{
    ...
    union
    {
        ...
        union
        {
            ...
            struct
            {
                ...
                /*!< [7..0] DLL and DLM register determines the baud rate of UARTn             */
            } DLL_b;
        };
    };
    ...
    union
    {
        union
        {
            ...
            struct
            {
                ...
                /*!< [7..0] DLL and DLM register determines the baud rate of USARTn            */
            } DLM_b;
        };
        ...
        union
        {
            ...
            struct
            {
                ...
                /*!< [0..0] RDA interrupt enable                                               */
                __IOM uint32_t THREIE : 1;
                /*!< [1..1] THRE interrupt enable                                              */
                __IOM uint32_t RLSIE : 1;
                /*!< [2..2] RLS interrupt enable                                               */
                uint32_t  : 1;
                __IOM uint32_t TEMTIE : 1;
                /*!< [4..4] TEMT interrupt enable                                              */
                uint32_t  : 3;
                __IOM uint32_t ABEOIE : 1;
                /*!< [8..8] ABE0 interrupt enable                                              */
                __IOM uint32_t ABTOIE : 1;
                /*!< [9..9] ABT0 interrupt enable                                              */
            } IE_b;
        };
    };
    ...
    union
    {
        union
        {
            ...
            struct
            {
                ...
                /*!< [0..0] Interrupt status                                                   */
                __IM  uint32_t INTID : 3;
                /*!< [3..1] Interrupt ID of RX FIFO                                            */
                uint32_t  : 2;
                __IM  uint32_t FIFOEN : 2;
                /*!< [7..6] Equal to FIFOEN bits in USARTn_FIFOCTRL register                   */
                __IM  uint32_t ABEOIF : 1;
                /*!< [8..8] ABEO interrupt flag                                                */
                __IM  uint32_t ABTOIF : 1;
                /*!< [9..9] ABTO interrupt flag                                                */
            } II_b;
        };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [2..2] Restart mode selection                                             */
            uint32_t  : 5;
            __OM  uint32_t ABEOIFC : 1;
            /*!< [8..8] Clear ABEOIF flag                                                  */
            __OM  uint32_t ABTOIFC : 1;
            /*!< [9..9] Clear ABTOIF flag                                                  */
        } ABCTRL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [3..0] Baud rate generation prescaler divisor value                       */
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t EP1_NAK_EN : 1;
            /*!< [0..0] EP1 NAK Interrupt Enable                                           */
            __IOM uint32_t EP2_NAK_EN : 1;
            /*!< [1..1] EP2 NAK Interrupt Enable                                           */
            __IOM uint32_t EP3_NAK_EN : 1;
            /*!< [2..2] EP3 NAK Interrupt Enable                                           */
            __IOM uint32_t EP4_NAK_EN : 1;
            /*!< [3..3] EP4 NAK Interrupt Enable                                           */
            __IOM uint32_t EPN_ACK_EN : 1;
            /*!< [4..4] EPN ACK Interrupt Enable                                           */
            uint32_t  : 23;
            __IOM uint32_t BUSWK_IE : 1;
            /*!< [28..28] USB Bus Wake Up Interrupt Enable                                 */
            __IOM uint32_t USB_IE : 1; /*!< [29..29] USB Event Interrupt Enable                                       */
            __IOM uint32_t USB_SOF_IE : 1;
            /*!< [30..30] USB SOF Interrupt Enable                                         */
    ...
    union
    {
        ...
        struct
        {
            __IM  uint32_t EP1_NAK : 1;
            /*!< [0..0] Endpoint 1 NAK transaction flag                                    */
            __IM  uint32_t EP2_NAK : 1;
            /*!< [1..1] Endpoint 2 NAK transaction flag                                    */
            __IM  uint32_t EP3_NAK : 1;
            /*!< [2..2] Endpoint 3 NAK transaction flag                                    */
            __IM  uint32_t EP4_NAK : 1;
            /*!< [3..3] Endpoint 4 NAK transaction flag                                    */
            uint32_t  : 4;
            __IM  uint32_t EP1_ACK : 1;
            /*!< [8..8] Endpoint 1 ACK transaction flag                                    */
            __IM  uint32_t EP2_ACK : 1;
            /*!< [9..9] Endpoint 2 ACK transaction flag                                    */
            __IM  uint32_t EP3_ACK : 1;
            /*!< [10..10] Endpoint 3 ACK transaction flag                                  */
            __IM  uint32_t EP4_ACK : 1;
            /*!< [11..11] Endpoint 4 ACK transaction flag                                  */
            uint32_t  : 5;
            __IM  uint32_t ERR_TIMEOUT : 1;
            /*!< [17..17] Timeout Status                                                   */
            __IM  uint32_t ERR_SETUP : 1;
            /*!< [18..18] Wrong Setup data received                                        */
            __IM  uint32_t EP0_OUT_STALL : 1;
            /*!< [19..19] EP0 OUT STALL transaction                                        */
            __IM  uint32_t EP0_IN_STALL : 1;
            /*!< [20..20] EP0 IN STALL Transaction is completed                            */
            __IM  uint32_t EP0_OUT : 1;
            /*!< [21..21] EP0 OUT ACK Transaction Flag                                     */
            __IM  uint32_t EP0_IN : 1; /*!< [22..22] EP0 IN ACK Transaction Flag                                      */
            __IM  uint32_t EP0_SETUP : 1;
            /*!< [23..23] EP0 Setup Transaction Flag                                       */
            __IM  uint32_t EP0_PRESETUP : 1;
            /*!< [24..24] EP0 Setup Token Packet Flag                                      */
            __IM  uint32_t BUS_WAKEUP : 1;
            /*!< [25..25] Bus Wakeup Flag                                                  */
            __IM  uint32_t USB_SOF : 1;
            /*!< [26..26] USB SOF packet received flag                                     */
            uint32_t  : 2;
            __IM  uint32_t BUS_RESUME : 1;
            /*!< [29..29] USB Bus Resume signal flag                                       */
            __IM  uint32_t BUS_SUSPEND : 1;
            /*!< [30..30] USB Bus Suspend signal flag                                      */
            __IM  uint32_t BUS_RESET : 1;
            /*!< [31..31] USB Bus Reset signal flag                                        */
        } INSTS_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __OM  uint32_t EP1_NAKC : 1;
            /*!< [0..0] EP1 NAK clear bit                                                  */
            __OM  uint32_t EP2_NAKC : 1;
            /*!< [1..1] EP2 NAK clear bit                                                  */
            __OM  uint32_t EP3_NAKC : 1;
            /*!< [2..2] EP3 NAK clear bit                                                  */
            __OM  uint32_t EP4_NAKC : 1;
            /*!< [3..3] EP4 NAK clear bit                                                  */
            uint32_t  : 4;
            __OM  uint32_t EP1_ACKC : 1;
            /*!< [8..8] EP1 ACK clear bit                                                  */
            __OM  uint32_t EP2_ACKC : 1;
            /*!< [9..9] EP2 ACK clear bit                                                  */
            __OM  uint32_t EP3_ACKC : 1;
            /*!< [10..10] EP3 ACK clear bit                                                */
            __OM  uint32_t EP4_ACKC : 1;
            /*!< [11..11] EP4 ACK clear bit                                                */
            uint32_t  : 5;
            __OM  uint32_t ERR_TIMEOUTC : 1;
            /*!< [17..17] Timeout Error clear bit                                          */
            __OM  uint32_t ERR_SETUPC : 1;
            /*!< [18..18] Error Setup clear bit                                            */
            __OM  uint32_t EP0_OUT_STALLC : 1;
            /*!< [19..19] EP0 OUT STALL clear bit                                          */
            __OM  uint32_t EP0_IN_STALLC : 1;
            /*!< [20..20] EP0 IN STALL clear bit                                           */
            __OM  uint32_t EP0_OUTC : 1;
            /*!< [21..21] EP0 OUT clear bit                                                */
            __OM  uint32_t EP0_INC : 1;
            /*!< [22..22] EP0 IN clear bit                                                 */
            __OM  uint32_t EP0_SETUPC : 1;
            /*!< [23..23] EP0 SETUP clear bit                                              */
            __OM  uint32_t EP0_PRESETUPC : 1;
            /*!< [24..24] EP0 PRESETUP clear bit                                           */
            __OM  uint32_t BUS_WAKEUPC : 1;
            /*!< [25..25] Bus Wakeup clear bit                                             */
            __OM  uint32_t USB_SOFC : 1;
            /*!< [26..26] USB SOF clear bit                                                */
            uint32_t  : 2;
            __OM  uint32_t BUS_RESUMEC : 1;
            /*!< [29..29] USB Bus Resume clear bit                                         */
            uint32_t  : 1;
            __OM  uint32_t BUS_RESETC : 1;
            /*!< [31..31] USB Bus Reset clear bit                                          */
        } INSTSC_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t EP1_DIR : 1;
            /*!< [0..0] Endpoint 1 IN/OUT direction setting                                */
            __IOM uint32_t EP2_DIR : 1;
            /*!< [1..1] Endpoint 2 IN/OUT direction setting                                */
            __IOM uint32_t EP3_DIR : 1;
            /*!< [2..2] Endpoint 3 IN/OUT direction setting                                */
            __IOM uint32_t EP4_DIR : 1;
            /*!< [3..3] Endpoint 4 IN/OUT direction setting                                */
            uint32_t  : 22;
            __IOM uint32_t DIS_PDEN : 1;
            /*!< [26..26] Enable internal D+ and D- 175k pull-down resistor                */
            ...
            __IOM uint32_t DPPU_EN : 1;
            /*!< [29..29] Enable internal D+ 1.5k pull-up resistor                         */
            __IOM uint32_t PHY_EN : 1; /*!< [30..30] PHY Transceiver Function Enable                                  */
            __IOM uint32_t VREG33_EN : 1;
            /*!< [31..31] Enable the internal VREG33 ouput                                 */
        } CFG_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t BUS_DRVEN : 1;
            /*!< [2..2] Enable to drive USB bus                                            */
        } SGCTL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t ENDP_CNT : 7;
            /*!< [6..0] Endpoint byte count                                                */
            uint32_t  : 20;
            __IOM uint32_t OUT_STALL_EN : 1;
            /*!< [27..27] Enable EP0 OUT STALL handshake                                   */
            __IOM uint32_t IN_STALL_EN : 1;
            /*!< [28..28] Enable EP0 IN STALL handshake                                    */
            __IOM uint32_t ENDP_STATE : 2;
            /*!< [30..29] Endpoint Handshake State                                         */
            __IOM uint32_t ENDP_EN : 1;
            /*!< [31..31] Enable Endpoint 0 Function                                       */
        } EP0CTL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [30..29] Endpoint Handshake State                                         */
            __IOM uint32_t ENDP_EN : 1;
            /*!< [31..31] Endpoint 1 Function enable bit                                   */
        } EP1CTL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [30..29] Endpoint Handshake State                                         */
            __IOM uint32_t ENDP_EN : 1;
            /*!< [31..31] Endpoint 2 Function enable bit                                   */
        } EP2CTL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [30..29] Endpoint Handshake State                                         */
            __IOM uint32_t ENDP_EN : 1;
            /*!< [31..31] Endpoint 3 Function enable bit                                   */
        } EP3CTL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            /*!< [30..29] Endpoint Handshake State                                         */
            __IOM uint32_t ENDP_EN : 1;
            /*!< [31..31] Endpoint 4 Function enable bit                                   */
        } EP4CTL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t ENDP1_DATA01 : 1;
            /*!< [0..0] Endpoint 1 data toggle bit                                         */
            __IOM uint32_t ENDP2_DATA01 : 1;
            /*!< [1..1] Endpoint 2 data toggle bit                                         */
            __IOM uint32_t ENDP3_DATA01 : 1;
            /*!< [2..2] Endpoint 3 data toggle bit                                         */
            __IOM uint32_t ENDP4_DATA01 : 1;
            /*!< [3..3] Endpoint 4 data toggle bit                                         */
        } EPTOGGLE_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IM  uint32_t FRAME_NO : 11;
            /*!< [10..0] The 11-bit frame number of the SOF packet                         */
        } FRMNO_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PHY_PARAM : 6;
            /*!< [5..0] USB PHY parameter                                                  */
        } PHYPRM_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PHY_PS : 15;
            /*!< [14..0] USB PHY parameter 2                                               */
        } PHYPRM2_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t RWDATA : 32;
            /*!< [31..0] Data to be read or written from/to USB FIFO                       */
        } RWDATA_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t W_STATUS : 1;
            /*!< [0..0] Write status of USB FIFO                                           */
            __IOM uint32_t R_STATUS : 1;
            /*!< [1..1] WRead status of USB FIFO                                           */
        } RWSTATUS_b;
    };
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            uint32_t  : 12;
            __OM  uint32_t FMCKEY : 16;
            /*!< [31..16] FMC verify key                                                   */
        } LPCTRL_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IM  uint32_t UserROM : 16;
            /*!< [15..0] Checksum of User ROM                                              */
            __IM  uint32_t BootROM : 16;
            /*!< [31..16] Checksum of Boot ROM                                             */
        } CHKSUM_b;
    };
